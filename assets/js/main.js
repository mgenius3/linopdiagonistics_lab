...
toggleBtn.addEventListener("click", function () {
  // Toggle the visibility of the phone and WhatsApp buttons
  callBtn.classList.toggle("show");
  whatsappBtn.classList.toggle("show");
  timesicon.classList.toggle("show");
  chaticon.classList.toggle("hide");

  chaticon.className = "fa-times";
  // Change the icon between 'times' and 'chat'
  // const icon = do.querySelector("i");
  // console.dir(icon);
  // if (toggleBtn.classList.contains("chat")) {
  //   console.log(toggleBtn.classList.remove("chat"));
  //   toggleBtn.classList.add("fa-times");
  // } else {
  //   toggleBtn.classList.remove("fa-times");
  //   toggleBtn.classList.add("chat");
  // }
});
